...
source('D:/R-Projects/TexasCovid/functions/compute_date_plot_limits.R')
...
x_limits <- compute_date_plot_limits( texas )
...
this_title   <- paste( "Texas nCovid-19 negativee tests\n",
                       "From", period[1], "to", period[2] )
